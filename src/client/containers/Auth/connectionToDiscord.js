...
class connectionToDiscord extends Component {
  ...
  componentDidMount() {
    axios
      .get(`https://dcordtroller-server.herokuapp.com/api/bot/asdasdsad%230617`)
      .then(res => {
        this.setState({
        ...
        <Fragment>
          <Layout
            ...
            newListOfBannedWords={listOfBannedWords =>
              this.setState({ listOfBannedWords: listOfBannedWords })
            }
...
export default withAuth(connectionToDiscord);
